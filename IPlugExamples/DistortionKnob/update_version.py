...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright FrankHartman, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/DistortionKnob-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionKnob-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionKnob-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionKnob-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionKnob-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionKnob-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DistortionKnob-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DistortionKnob.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DistortionKnob.iss",inplace=1):
